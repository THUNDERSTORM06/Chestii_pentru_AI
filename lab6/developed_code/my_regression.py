...
def my_linear_regression(gdp, freedom, outputs):
    ...
    res_final = multiplication(res, outputs_transpose)

    w0, w1, w2 = res_final[0][0], res_final[1][0], res_final[2][0]
    print(' Learnt model: f(x) = ', w2, ' * x^2 + ', w1, ' * x + ', w0)
